...
{
    global $time_offset;
    return "SELECT DISTINCT pokemon_id, encounter_id, ( CONVERT_TZ( FROM_UNIXTIME(expire_timestamp), '+00:00', '".$time_offset."')) AS disappear_time, ( CONVERT_TZ( FROM_UNIXTIME(sightings.updated), '+00:00', '".$time_offset."')) AS last_modified, ( CONVERT_TZ( FROM_UNIXTIME(expire_timestamp), '+00:00', '".$time_offset."') ) AS disappear_time_real,
